...
namespace HomeExercises
{
    public class NumberValidator_Should
    {
        ...
        [TestCase("0,1", 2, 1, TestName = "ForCommatDelimiter_ReturnTrue")]
        ...
        [TestCase("11", 1, TestName = "ForNumber_WhenNumbersLengthMoreThanPrecision_ReturnFalse")]
        [TestCase("1.11", 2, 1, TestName = "ForNumber_WhenFractNumbersLengthMoreThanScale_ReturnFalse")]
